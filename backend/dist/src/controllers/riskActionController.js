...
export class RiskActionController {
    ...
    async getAllRiskActions(req, res) {
        try {
    ...
    async getRiskActionById(req, res) {
        try {
            const { id } = req.params;
    ...
    async getRiskActionsByRisk(req, res) {
        try {
    ...
    async createRiskAction(req, res) {
        try {
            const data = req.body;
    ...
    async updateRiskAction(req, res) {
        try {
            const { id } = req.params;
            const data = req.body;
    ...
    async deleteRiskAction(req, res) {
        try {
            const { id } = req.params;
