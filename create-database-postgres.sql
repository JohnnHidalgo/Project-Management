-- Script SQL para crear la base de datos y aplicar todas las migraciones de Prisma
-- Ejecutar este script en PostgreSQL (por ejemplo, con psql -f script.sql)
-- Asegúrate de tener permisos para crear bases de datos

-- Crear la base de datos (ejecutar esto primero si no existe)
-- Nota: Si ejecutas este script completo, el CREATE DATABASE debe ser separado
-- CREATE DATABASE project_management;

-- Conectarse a la base de datos recién creada antes de ejecutar el resto
-- \c project_management;

-- Migración 1: 20260330150157_init
-- CreateEnum
...
-- Migración 2: 20260401160337_add_task_weight
-- AlterTable
ALTER TABLE "Task" ADD COLUMN     "weight" INTEGER NOT NULL DEFAULT 0;

-- Migración 3: 20260402173130_migration
-- CreateTable
...
-- Migración 4: 20260408032226_add_tasks_to_risk_actions
-- AlterTable
...
-- Migración 5: 20260408230000_add_execution_date_to_budget_line
