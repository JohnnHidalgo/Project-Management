-- Script SQL completo para crear el esquema y poblar datos en la base de datos de Project Management
-- Asume que la base de datos 'project_management' ya existe
-- Ejecutar con: psql "postgresql://dbaqas1:Dba_qa_JH@192.168.103.15:5432/project_management?schema=public" -f create-full-database.sql
...
CREATE TABLE "Project" (
    ...
    "startDate" TIMESTAMP,
    "endDate" TIMESTAMP,
    "pmId" TEXT REFERENCES "User"(id) ON DELETE CASCADE,
    "pmoId" TEXT REFERENCES "User"(id) ON DELETE CASCADE,
    "businessCase" TEXT,
    ...
    "pmCanEdit" BOOLEAN DEFAULT false
);

CREATE TABLE "ProjectSponsor" (
    "projectId" TEXT REFERENCES "Project"(id) ON DELETE CASCADE,
    "sponsorId" TEXT REFERENCES "User"(id) ON DELETE CASCADE,
    PRIMARY KEY ("projectId", "sponsorId")
);

CREATE TABLE "ProjectTeamMember" (
    "projectId" TEXT REFERENCES "Project"(id) ON DELETE CASCADE,
    "teamMemberId" TEXT REFERENCES "User"(id) ON DELETE CASCADE,
...
CREATE TABLE "RiskAction" (
    id TEXT PRIMARY KEY,
    "riskId" TEXT REFERENCES "Risk"(id) ON DELETE CASCADE,
    description TEXT NOT NULL,
    "ownerId" TEXT REFERENCES "User"(id) ON DELETE SET NULL,
    "dueDate" TIMESTAMP,
    status "ApprovalStatus" NOT NULL
...
CREATE TABLE "Task" (
    id TEXT PRIMARY KEY,
    "milestoneId" TEXT REFERENCES "Milestone"(id) ON DELETE CASCADE,
    "riskActionId" TEXT REFERENCES "RiskAction"(id) ON DELETE CASCADE,
    name TEXT NOT NULL,
    description TEXT,
    "startDate" TIMESTAMP,
    "endDate" TIMESTAMP,
    ...
    "predecessorId" TEXT REFERENCES "Task"(id) ON DELETE SET NULL
);
...
CREATE TABLE "Expense" (
    id TEXT PRIMARY KEY,
    "projectId" TEXT REFERENCES "Project"(id) ON DELETE CASCADE,
    "budgetLineId" TEXT REFERENCES "BudgetLine"(id) ON DELETE SET NULL,
...
CREATE TABLE "ChangeRequest" (
    ...
    "originalStartDate" TIMESTAMP NOT NULL,
    ...
    "requestedBy" TEXT REFERENCES "User"(id) ON DELETE CASCADE,
...
CREATE TABLE "ProjectSnapshot" (
    ...
    "risksIds" JSONB,
    "issuesIds" JSONB,
    "milestonesProgress" JSONB,
    "overviewData" JSONB,
    "reportData" JSONB,
    "savedBudgetLines" JSONB,
    "savedExpenses" JSONB,
...
CREATE TABLE "LessonLearned" (
    ...
    "submittedBy" TEXT REFERENCES "User"(id) ON DELETE CASCADE,
    date TIMESTAMP NOT NULL
);

-- Insertar datos de prueba (mismo contenido que seed-data.sql)
-- [Aquí irían todos los INSERT statements del archivo anterior]
...
-- Tasks
INSERT INTO "Task" (id, "milestoneId", name, description, "startDate", "endDate", "assignedTo", progress, status, priority) VALUES
('t1', 'm1', 'Diseño de VPC', 'Definir subredes y seguridad', '2026-01-05', '2026-01-15', '4', 100, 'Completed', 'High'),
('t2', 'm1', 'Túnel VPN con Local', 'Conectividad segura', '2026-01-16', '2026-01-30', '5', 100, 'Completed', 'High'),
('t3', 'm2', 'Limpieza de Datos', 'Eliminar registros obsoletos', '2026-02-20', '2026-03-30', '4', 80, 'In_Progress', 'Medium'),
('t4', 'm2', 'Script de Migración', 'Desarrollo de ETL', '2026-04-01', '2026-05-15', '5', 10, 'Pending', 'High'),
('t5', 'm4', 'Levantamiento Requerimientos', 'Entrevistas con ventas', '2026-03-05', '2026-03-25', '6', 40, 'In_Progress', 'High')
ON CONFLICT (id) DO UPDATE SET
